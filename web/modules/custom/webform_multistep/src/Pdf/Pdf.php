  ...
  class Pdf {
    ...
    public function test($table = false) {
      if ($table)
        ...
        $content = 'Suspendisse nisl elit, rhoncus eget, elementum ac, condimentum eget, diam. now go to next page using p+p+p formula. <p></p><p></p><p></p> Proin faucibus arcu quis ante. Sed fringilla mauris sit amet nibh. <p></p><p></p><p></p> Line breaked through p+p+p html formula!';
