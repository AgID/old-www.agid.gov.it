...
use Drupal\agid_fixtures\AgidFixturesRepositoryFileMigrationFactoryInterface;
...
class FileEntity extends File {
   ...
   *
   * @var \Drupal\agid_fixtures\AgidFixturesRepositoryFileMigrationFactoryInterface
   */
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition, MigrationInterface $migration = NULL) {
    return new static(
      ...
      $container->get('agid_fixtures.repository_file_migration.factory'),
