...
/**
 * @file
 * Contains \Drupal\sparkminimal\Tests\MinimalTest.
 */

namespace Drupal\sparkminimal\Tests;
 ...
 * @group minimal
 */
class SparkinimalTest extends WebTestBase {

  protected $profile = 'sparkminimal';

  /**
   * Tests Sparkminimal installation profile.
   */
  function testSparkminimal() {
    $this->drupalGet('');
